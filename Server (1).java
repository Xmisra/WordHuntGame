...
import java.sql.SQLException;  // New import for SQL exceptions
import java.util.concurrent.ConcurrentHashMap;  // New import for ConcurrentHashMap
...
public class Server {
    ...
    private static final int SERVER_PORT = 12345; // Example port
    ...
    public static void main(String[] args) {
        ...
        // Start the server socket and accept client connections
    ...
    private static class ClientHandler implements Runnable {
        ...
        private void declareWinner() {
            ...
            // New: Save game results to database
            try {
        ...
        /**
         * Step 1: Check if the word can be formed using letters in the grid.
         * Allows repeated use of letters that exist in the grid.
         */
        private boolean isWordFormableFromGrid(String word) {
            // Create a set of all unique letters in the grid
            ...
            // Check if all characters in the word exist in the grid
        ...
        /**
         * Step 2: Updated scoring logic.
         * Returns 3 points if the word length is 5 or more, 1 point otherwise,
         * only if the word exists in the dictionary and is formable from the grid.
         * Otherwise, returns -1.
         */
